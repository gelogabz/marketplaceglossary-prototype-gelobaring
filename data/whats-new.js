...
export const updates = [
  ...
  },
  {
    ...
    summary:
      "Most AI systems today have no direct understanding of the physical world because the underlying spatial data requires purpose-built preprocessing before AI can use it.",
    type: "blog",
    sourceUrl:
      "https://aws.amazon.com/blogs/apn/bring-context-from-the-physical-world-to-ai-with-wherobots-on-aws/",
    impact: "low",
  },
  {
    ...
    summary:
      "We are excited to highlight 169 AWS Partners that received new or renewed specializations in May for our global AWS Competency programs.",
    type: "blog",
    sourceUrl:
      "https://aws.amazon.com/blogs/apn/say-hello-to-169-new-aws-competency-partners-added-in-may/",
    impact: "medium",
  },
  {
  ...
  },
  {
    ...
    summary:
      "Learn how Fovus, an AWS Advanced Technology Partner, eliminates the inefficiency of static Nextflow resource configurations by benchmarking each pipeline process individually and applying AI-powered orchestration to select optimal EC2 instance types, memory, storage, and paralle…",
    type: "blog",
    sourceUrl:
      "https://aws.amazon.com/blogs/apn/data-driven-optimization-and-ai-powered-orchestration-for-nextflow-with-fovus-on-aws/",
    impact: "low",
  },
  {
  ...
  },
  {
    ...
    summary:
      "AWS Specializations and AWS Marketplace Vendor Insights work together to transform vendor evaluation. By combining rigorous, domain-specific technical validations from AWS across more than 115 solution areas with continuously updated security posture dashboards, these complement…",
    type: "blog",
    sourceUrl:
      "https://aws.amazon.com/blogs/apn/accelerate-vendor-evaluation-with-aws-specializations-and-aws-marketplace/",
    impact: "medium",
  },
  {
