export const terms = [
  ...
  },
  {
    ...
    alias: "Related: BYOL, Contract (AWS), Product Code (AWS)",
  },
  {
  ...
  },
  {
    ...
    alias: "Now part of: Microsoft Marketplace",
  },
  {
  ...
  {
    name: "AWS Marketplace Management Portal (AMMP)",
    tags: ["aws"],
  ...
  },
  {
    ...
    alias: "Formerly: Azure Marketplace + AppSource",
  },
  {
  ...
  {
    name: "Co-sell Eligible / Co-sell Incentivized (Azure)",
    tags: ["azure", "cosell"],
  ...
  },
  {
    ...
    alias: "AWS: EDP | Azure: MACC | GCP: CUD",
  },
  {
    name: "Contract (AWS)",
    tags: ["aws"],
  ...
  },
  {
    ...
    def: "A program where an ISV creates a resale authorization (with a wholesale price) that an authorized channel partner uses to create a private offer — with markup — for an end customer. The channel partner is the seller of record. The ISV sees only the wholesale cost; the end customer price is visible only to the channel partner.",
    alias:
      "GCP equivalent: MCPO / RPOP | Azure equivalent: MPO (Multiparty Private Offer)",
  },
  {
    ...
    alias:
      "See also: Salesforce Integration, HubSpot Integration, Salesforce App (Suger), HubSpot App (Suger)",
  },
  {
  ...
  {
    name: "EDP (Enterprise Discount Program) — AWS",
    tags: ["aws"],
    ...
    alias: "Also known as: PPA (Private Pricing Agreement)",
  },
  {
    name: "Entitlement",
    tags: ["suger"],
  ...
  },
  {
    ...
    alias: "Related: Listing, BYOL, Transactable Offer",
  },
  {
    ...
    alias:
      "Related: ABO (Agreement-Based Offer), CPPO, Flexible Payment Schedule",
  },
  {
    name: "GCP Marketplace (Google Cloud Marketplace)",
    tags: ["gcp"],
  ...
  {
    name: "Marketplace Customer Credit Program (GCP)",
    tags: ["gcp", "cosell"],
    ...
    alias: "Also referred to as: MCCP",
  },
  {
  ...
  },
  {
    ...
    alias:
      "Related: Usage Metering, Billable Metric, Metering Dimension, Overage",
  },
  {
  ...
  {
    name: "MPN / Microsoft AI Cloud Partner Program",
    tags: ["azure", "cosell"],
  ...
  {
    name: "MPO (Multiparty Private Offer) — Azure",
    ...
    alias: "AWS equivalent: CPPO | GCP equivalent: MCPO / RPOP",
  },
  {
  ...
  },
  {
    ...
    alias: "AWS: Private Offer | Azure: Plan or Private Offer | GCP: Offer",
  },
  {
  ...
  {
    name: "POST (Private Offer Success Team)",
    tags: ["aws"],
  ...
  },
  {
    ...
    alias:
      "AWS: Product (Product Code) | Azure: Offer (Offer Id) | GCP: Product (Product Id)",
  },
  {
  ...
  },
  {
    ...
    alias: "Also called: Selling Authorization, Opportunity (in AWS API docs)",
  },
  {
  ...
  {
    name: "SCMP (Standard Contract for AWS Marketplace)",
    tags: ["aws"],
  ...
  },
  {
    ...
    alias: "Related: Snowflake Integration, Private Offer, Listing",
  },
  {
    name: "SPPO (Solution Provider Private Offer)",
    tags: ["aws", "cosell", "offers"],
    ...
    alias: "Related: CPPO, ISV Accelerate (AWS), Resale Authorization (AWS)",
  },
  {
    name: "Suger",
    tags: ["suger"],
  ...
  {
    name: "Usage Record / Usage Record Group",
    tags: ["suger"],
  ...
  },
  {
    ...
    alias: "Related: Email Notification (Suger), Workflow, Integration (Suger)",
  },
  {
    name: "Workflow",
    tags: ["suger"],
    ...
    alias: "Related: Webhook, Integration (Suger), CRM Integration",
  },
  {
  ...
  },
  {
    ...
    def: "Alibaba Cloud's digital marketplace connecting ISVs and SaaS providers with Alibaba Cloud customers globally and in China. Supports private offers, usage metering, and consolidated billing through Alibaba Cloud accounts. Suger supports listing and entitlement management on this platform.",
